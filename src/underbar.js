(function() {
  ...
  _.each = function(collection, iterator) {
    if(collection instanceof Array) {
  	  for(var index = 0; index < collection.length; index++) iterator(collection[index], index, collection);  
  	} else {
  ...
  _.map = function(collection, iterator) {
    ...
    var result = [];
    _.each(collection, x => result.push(iterator(x)));
    return result;
  };
